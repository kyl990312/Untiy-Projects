...
public class FollowCam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            height = Mathf.Lerp(height, originHegiht, Time.deltaTime * overDamping);
        }
    ...
    void OnDrawGizmos()
    {
        ...
        // 카메라의 충돌체를 표현ㄷ하기 위한 구체를 표시
        Gizmos.color = Color.yellow;
        Gizmos.DrawWireSphere(transform.position, colliderRadius);

        // 주인공 캐릭터가 장애물에 가려졌는지를 판단할 레이어 표시
