...
public class Damage : MonoBehaviour
{
    ...
    // 델리게이트 및 이벤트 선언
    public delegate void PlayeDieHandler();
    public static event PlayeDieHandler OnPlayerDie;
    ...
    void PlayerDie()
    {
        ...
        //// "ENEMY" 태드로 지정된 모든 적 캐릭터를 추출해 배열에 저장
        //GameObject[] enemies = GameObject.FindGameObjectsWithTag(enemyTag);

        //// 배열의 처음부터 순회하면서 적 캐릭터의 OnPlayerDie함수를 호출
